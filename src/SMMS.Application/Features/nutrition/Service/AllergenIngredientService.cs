...
public class AllergenIngredientService : Service<AllergeticIngredient>, IAllergenIngredientService
{
    public AllergenIngredientService(EduMealContext dbContext) : base(dbContext)
    {
    }
}
