...
public class NotificationRecipientService : Service<NotificationRecipient>, INotificationRecipientService
{
    public NotificationRecipientService(EduMealContext dbContext) : base(dbContext)
    {
    }
}
