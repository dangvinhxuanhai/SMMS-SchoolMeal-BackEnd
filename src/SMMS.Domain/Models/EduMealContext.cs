...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.YearId).HasName("PK__Academic__C33A18CD36B0EA31");
        ...
        {
            entity.HasKey(e => e.AllergenId).HasName("PK__Allergen__158B939FDCFDEFA0");
        ...
        {
            entity.HasKey(e => new { e.IngredientId, e.AllergenId }).HasName("PK__Allerget__5FF60B6377398DEE");
        ...
        {
            entity.HasKey(e => e.AttendanceId).HasName("PK__Attendan__8B69261CE0A4B967");
        ...
        {
            entity.HasKey(e => e.LogId).HasName("PK__AuditLog__5E548648228180C9");
        ...
        {
            entity.HasKey(e => e.ClassId).HasName("PK__Classes__CB1927C07C78CE6C");
        ...
        {
            entity.HasKey(e => e.DailyMealId).HasName("PK__DailyMea__4325CAFBF7E5FB97");
        ...
        {
            entity.HasKey(e => e.ProviderId).HasName("PK__External__B54C687DE3F7062B");
        });

        modelBuilder.Entity<Feedback>(entity =>
        {
            entity.HasKey(e => e.FeedbackId).HasName("PK__Feedback__6A4BEDD60EB64279");
        ...
        {
            entity.HasKey(e => e.SampleId).HasName("PK__FoodInFr__8B99EC6AACFDCFCB");
            ...
            entity.HasMany(d => d.Ingredients).WithMany(p => p.Samples)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("SampleId", "IngredientId").HasName("PK__Ingredie__3073074FAC9B381C");
        ...
        {
            entity.HasKey(e => e.FoodId).HasName("PK__FoodItem__856DB3EB03AC8983");
        ...
        {
            entity.HasKey(e => new { e.FoodId, e.IngredientId }).HasName("PK__FoodItem__3E8758CEADFA0CC2");
        ...
        {
            entity.HasKey(e => e.IngredientId).HasName("PK__Ingredie__BEAEB25A6F62A407");
        ...
        {
            entity.HasKey(e => new { e.IngredientId, e.AltIngredientId }).HasName("PK__Ingredie__790D4520A060C7AF");
        ...
        {
            entity.HasKey(e => e.ItemId).HasName("PK__Inventor__727E838B4A245867");
        ...
        {
            entity.HasKey(e => e.TransId).HasName("PK__Inventor__9E5DDB3C2232D734");
        ...
        {
            entity.HasKey(e => e.InvoiceId).HasName("PK__Invoices__D796AAB5B5647442");
        ...
        {
            entity.HasKey(e => e.AttemptId).HasName("PK__LoginAtt__891A68E6E78DD138");
        ...
        {
            entity.HasKey(e => e.MenuId).HasName("PK__Menus__C99ED230CCB6CD89");
        ...
        {
            entity.HasKey(e => e.MenuDayId).HasName("PK__MenuDays__48283E543A016223");
        ...
        {
            entity.HasKey(e => e.NotificationId).HasName("PK__notifica__20CF2E12690ABCE2");
        ...
        {
            entity.HasKey(e => new { e.NotificationId, e.UserId }).HasName("PK__Notifica__F1B7A2D6BCED699E");
        ...
        {
            entity.HasKey(e => e.PaymentId).HasName("PK__Payments__9B556A38B2A3A159");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__Purchase__C3905BCF03E9D04E");
        ...
        {
            entity.HasKey(e => e.LinesId).HasName("PK__Purchase__728C596D807AE76D");
        ...
        {
            entity.HasKey(e => e.PlanId).HasName("PK__Purchase__755C22B7808D2258");
        ...
        {
            entity.HasKey(e => new { e.PlanId, e.IngredientId }).HasName("PK__Purchase__CEB6C992D3E32962");
        ...
        {
            entity.HasKey(e => new { e.RequestId, e.AllergenId }).HasName("PK__RAG_Requ__D2F0E843E7AD764D");
        ...
        {
            entity.HasKey(e => e.RagInputId).HasName("PK__RAG_Requ__94C425D2FE42DEB8");
        ...
        {
            entity.HasKey(e => e.SuggestedFoodItemId).HasName("PK__RAG_Sugg__5F9F55F6DD5BF797");
        ...
        {
            entity.HasKey(e => new { e.SuggestedFoodItemId, e.SuggestedIngredientId }).HasName("PK__RAG_Sugg__F988B1EDCD2AE12B");
        ...
        {
            entity.HasKey(e => e.SuggestedIngredientId).HasName("PK__RAG_Sugg__617E41BBF8273688");
        ...
        {
            entity.HasKey(e => e.RefreshTokenId).HasName("PK__RefreshT__F5845E390D919FA3");
        ...
        {
            entity.HasKey(e => e.RoleId).HasName("PK__Roles__8AFACE1A7C21234E");
        ...
        {
            entity.HasKey(e => e.ScheduleMealId).HasName("PK__Schedule__7F2713EE9F67B5F9");
        ...
        {
            entity.HasKey(e => e.SchoolId).HasName("PK__Schools__3DA4675B2CCBC21D");
        ...
        {
            entity.HasKey(e => e.StageId).HasName("PK__StagingS__03EB7AD8F298A203");
        ...
        {
            entity.HasKey(e => e.StudentId).HasName("PK__Students__32C52B99DD1FAD8E");
        ...
        {
            entity.HasKey(e => new { e.StudentId, e.AllergenId }).HasName("PK__StudentA__D39D92A0AFB8C906");
        ...
        {
            entity.HasKey(e => new { e.StudentId, e.ClassId }).HasName("PK__StudentC__2E74B9E58CBEAEF1");
        ...
        {
            entity.HasKey(e => e.RecordId).HasName("PK__StudentH__FBDF78E9A72858C4");
        ...
        {
            entity.HasKey(e => e.ImageId).HasName("PK__StudentI__7516F70CA71BC33B");
        ...
        {
            entity.HasKey(e => new { e.ImageId, e.TagId }).HasName("PK__StudentI__A3413896E7D55A9F");
        ...
        {
            entity.HasKey(e => e.TagId).HasName("PK__Tags__657CF9AC7FC9A1A3");
        ...
        {
            entity.HasKey(e => e.TeacherId).HasName("PK__Teachers__EDF25964DE18A100");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__Users__1788CC4C4FD0E7D8");
        ...
        {
            entity.HasKey(e => new { e.UserId, e.ProviderId, e.ProviderSub }).HasName("PK__UserExte__923A6277A4DF3E54");
